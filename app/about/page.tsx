      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-extrabold text-gray-900">Sandeep's Journey as a Coder</h2>
            <p className="mt-4 text-lg text-gray-600">
              From curious beginner to seasoned developer, here's how Sandeep navigated the world of programming.
            </p>
          </div>
          <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row-reverse items-center">
              ...
              <div className="md:w-2/3 md:pr-8 mt-8 md:mt-0">
                ...
                <p className="mt-4 text-gray-600">
                  Today, Sandeep is not only a proficient coder but also a mentor to others. He regularly contributes to the programming community by writing tutorials, giving talks, and helping new coders find their footing in the world of software development. For Harry, coding is more than just a profession—it’s a lifelong journey of learning and sharing knowledge.
                </p>
              </div>
            </div>
          </div>
